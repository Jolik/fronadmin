...
type
  ...
  private
    ...
    function Post(AURL: string; const ASourceFile: string): string;
...
//  IdSSLIOHandler.SSLOptions.Mode := sslmClient;
  ...
  IdHTTP.Request.CustomHeaders.AddValue('X-Ticket', X_TICKET);
...
function TUniMainModule.Post(AURL: string; const ASourceFile: string): string;
begin
